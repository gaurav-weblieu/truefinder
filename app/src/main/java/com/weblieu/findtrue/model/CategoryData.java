...
public class CategoryData {
    ...
    @SerializedName("full_profile_pic")
    @Expose
    private String fullProfilePic;
    ...
    public String getFullProfilePic() {
        return fullProfilePic;
    }

    public void setFullProfilePic(String fullProfilePic) {
        this.fullProfilePic = fullProfilePic;
    }
